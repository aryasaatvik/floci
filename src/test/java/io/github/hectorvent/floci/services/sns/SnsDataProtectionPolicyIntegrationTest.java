...
class SnsDataProtectionPolicyIntegrationTest {
    ...
    private static final String POLICY =
            "{\"Name\":\"data_protection_policy\",\"Version\":\"2021-06-01\","
    ...
    @Test
    @Order(11)
    void createFifoTopic() {
        fifoTopicArn = given()
                .contentType("application/x-www-form-urlencoded")
                .formParam("Action", "CreateTopic")
                .formParam("Name", "dpp-integration-topic.fifo")
                .when()
                .post("/")
                .then()
                .statusCode(200)
    ...
    @Test
    @Order(12)
    void getDataProtectionPolicy_query_rejectsFifoTopic() {
        given()
                .contentType("application/x-www-form-urlencoded")
                .formParam("Action", "GetDataProtectionPolicy")
                .formParam("ResourceArn", fifoTopicArn)
                .when()
                .post("/")
                .then()
                .statusCode(400)
    ...
    @Test
    @Order(13)
    void putDataProtectionPolicy_json_rejectsFifoTopic() {
        given()
                .contentType(SNS_CONTENT_TYPE)
                .header("X-Amz-Target", "SNS_20100331.PutDataProtectionPolicy")
                .body(Map.of("ResourceArn", fifoTopicArn, "DataProtectionPolicy", POLICY))
                .when()
                .post("/")
                .then()
                .statusCode(400)
